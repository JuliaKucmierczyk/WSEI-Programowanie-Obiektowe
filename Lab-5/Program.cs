...
class App
{
    ...
    {
        Exercise1 team = new Exercise1() { Manager };
...
//Ola
//Ewa
public class Exercise1 : IEnumerable<T>
{
...
class Exercise1Enumerator : IEnumerator<T>
{
    private Exercise1 _exercise1;
    int counter = -1;

    public Exercise1Enumerator(Exercise1 exercise1)
    {
